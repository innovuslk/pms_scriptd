...
def main():
    ...
    if conn is not None:
        try:
            ...
            time_t = timestamp = datetime(2024, 7, 6, 8, 10)
            ...
            lineshift2 = get_shift_for_line(conn,date, 'UP007%')
            ...
            user_id3,lineNo3,m3shift = get_userid(conn,date,lineshift2, 'LineEnd','UP007%')
            user_id4,lineNo4,m4shift = get_userid(conn,date,lineshift2, 'Pullout 1','UP007%')
            user_id5,lineNo5,m5shift = get_userid(conn,date,lineshift2, 'Pullout 2','UP007%')
